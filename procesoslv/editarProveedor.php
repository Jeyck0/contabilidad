...
// echo $rut_proveedor_in;
// echo $razon_social_proveedor_in;
// echo $giro_proveedor_in;

$proveedor = new Proveedor();
$proveedor->actualizarDatosProveedor($id,$rut_proveedor_in,$razon_social_proveedor_in,$giro_proveedor_in);
