...
if(isset($_POST['crear_egreso_btn_aceptarSep'])){

    $id = $_POST['id'];
    
    $select_cuenta_egresos = 1;
    $select_cat_egresos = $_POST['select_cat_egresos'];
    $select_factura_egreso = $_POST['select_factura_egreso'];
}

$egreso = new Egreso();
$egreso->updateEgresoSep($id,$select_cuenta_egresos,$select_cat_egresos,$select_factura_egreso);
