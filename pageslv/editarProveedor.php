...
$datos = $proveedor->obtenerDatosProveedorId($id);
            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-body">
                        ...
                        <form action="../procesoslv/editarProveedor.php" class="form-sample" method="POST" name="formulario1">
                            <div class="form-group">
                                <input type="text" hidden name="id" value="<?php echo $id;?>">
                                <label for="">Rut</label>
                                <input type="text" class="form-control" name="rut_proveedor_in" value="<?php echo $rut?>">
                            </div>
                            <div class="form-group">
                                <label for="">Razon Social</label>
                                <input type="text" class="form-control" name="razon_social_proveedor_in" value="<?php echo $razon_social?>">
                            </div>
                            <div class="form-group">
                                <label for="">Giro</label>
                                <input type="text" class="form-control" name="giro_proveedor_in" value="<?php echo $giro?>"> 
                            </div>
                            <div class="form-group">
