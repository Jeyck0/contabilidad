...
include_once ("../claseslv/Conexion.php");
include_once ("../claseslv/Egreso.php");
...
function tabla($s_id){
	...
	while($row=$consultar->fetch_assoc()){
        ...
        $tabla.='<div class="paguese">Congregación Instituto Hijas de María Auxiliadora.</div>';
        $tabla.='<div class="lasumade">70.083.600-2</div>';
