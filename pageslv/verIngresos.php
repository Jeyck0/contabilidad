                        ...
                        <?php for($i=0;$i<sizeof($datos2);$i++){?>
                            <tr>
                                ...
                                <th>
                                    ...
                                    <a href="editarIngreso.php?id=<?php echo $datos2[$i]["c0"]; ?>" type="submit" name="descargar" class="btn btn-xs btn-warning">Editar</a>
                                </th>
                    ...
                    <caption>Ingresos PIE</caption>
                        ...
                        <?php for($i=0;$i<sizeof($datos3);$i++){?>
                            <tr>
                                ...
                                <a href="editarIngreso.php?id=<?php echo $datos3[$i]["c0"]; ?>" type="submit" name="descargar" class="btn btn-xs btn-warning">Editar</a>
                                </th>
